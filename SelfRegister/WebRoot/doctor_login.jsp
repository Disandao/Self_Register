...
String doctorname = (String)request.getSession().getAttribute("doctorname");
 %>
 <input name="docid" type="hidden" id="id" value="<%=doctorid%>">
 <div id="wrap">

	<div id="top">
				<div class="rights">	</div>
				<div id="search">
						<h2><li><a href="index.jsp" title="">退出</a></li></h2>
					</div>
				<div class="lefts">
					<h1>欢迎您！<%=doctorname%>医生！</h1>
					<h2></h2>
				</div>
	</div>
	...
	<div id="topmenu">
				<div class="rights"></div>
				<div class="lefts"><ul>
				<li><a href="DocLog"  target="_top">主页</a></li>
						
							<li><a href="ListPatient?docid=<%=doctorid%>" target="_top">查看预约病人</a></li>
